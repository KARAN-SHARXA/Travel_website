...
const AmbDharamshalaBook = () => {
  ...
  const generateBookingNumber = () => `AD${Date.now().toString().slice(-6)}`;
...
I want to book *Amb Anduara → Dharamshala Fixed Tour Package*.

*Booking No:* ${bookingNumber}
*Pickup:* Amb Anduara Railway Station
*Destination:* Dharamshala Tour
*Route:*
  - Dharamshala
  - McLeodganj
  - Dalhousie
      ...
      <section className="bg-charcoal text-cream py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl font-bold mt-2 font-display">
            Amb Anduara → <span className="text-primary">Dharamshala Tour</span>
          </h1>
...
export default AmbDharamshalaBook;
